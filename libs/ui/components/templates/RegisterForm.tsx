...
import { useFormRegister } from '@couponcloud/forms/src/register'
import { useMutation } from '@apollo/client'
import { CreateUserWithCredentialsDocument } from '@couponcloud/network/src/gql/generated'
  ...
  return (
    <Form
      onSubmit={handleSubmit(async (formData) => {
        ...
        if (data) {
          // alert(`User ${data.createUserWithCredentials.id} created. 🎉`)
          signIn('credentials', {
    ...
    >
      ...
      <div className="mt-4 text-sm ">
        Already have an CouponCloud account?
        <br />
